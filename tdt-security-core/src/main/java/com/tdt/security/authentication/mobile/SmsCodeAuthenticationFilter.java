package com.tdt.security.authentication.mobile;
...
public class SmsCodeAuthenticationFilter extends
    ...
    public static final String TDT_FORM_MOBILE_KEY = "mobile";

    private String mobileParameter = TDT_FORM_MOBILE_KEY;
